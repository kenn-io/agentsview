...
## title: AgentsView description: Local-first desktop and web app for AI agent sessions
...
- **Multi-Agent Support**
  ...
  including Claude Code, Codex, Copilot, Cursor, Gemini, OpenHands, Aider,
  Claude Cowork, DeepSeek TUI, gptme, Kilo, MiMoCode, Mistral Vibe, OhMyPi,
  QwenPaw, Reasonix, Shelley, and Visual Studio Copilot. Auto-discovers session
