...
<div class="agent-grid">
  ...
  <a class="agent-chip" data-agent="posit-assistant" href="https://github.com/posit-dev/assistant" target="_blank" rel="noopener"><span class="agent-chip__glyph"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="#i-posit"/></svg></span><span class="agent-chip__name">Posit Assistant</span></a>
