...
| `[ledger]`                          | Optional append-only event ledger; zones in `[[ledger.zones]]` — see [Event Ledger](/docs/event-ledger/)                                                                                                                                                                                                                                                                                                                                                                         |
...
| `[kata]`                            | Optional Kata issue-tracker connection; off by default; HTTPS needs `token_env` — see [Kata](/docs/kata/)                                                                                                                                                                                                                                                                                                                                                                      |
