...
import type {
  ...
  RawsyncJobHealthReport,
  RawsyncManifest,
} from "../models";

import { orvalFetch } from "../../runtime.ts";

export const getGetApiV1RawSyncHealthUrl = (params: GetApiV1RawSyncHealthParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/raw-sync/health?${stringifiedParams}`
    : `/api/v1/raw-sync/health`;
};

/**
 * @summary Report raw parse-job health
 */
export const getApiV1RawSyncHealth = async (
  params: GetApiV1RawSyncHealthParams,
  options?: Parameters<typeof orvalFetch>[1],
): Promise<RawsyncJobHealthReport> => {
  return orvalFetch<RawsyncJobHealthReport>(getGetApiV1RawSyncHealthUrl(params), {
    ...options,
    method: "GET",
  });
};
