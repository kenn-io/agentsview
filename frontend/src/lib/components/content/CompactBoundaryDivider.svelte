...
<div class="boundary" title={t(m.compact_boundary_title)}>
  ...
  {#if hasMore}
    <details class="boundary-details">
      <summary class="boundary-preview">
        <span>{preview}</span>
        <span class="boundary-expand-hint">{t(m.compact_boundary_show_full_summary)}</span>
      </summary>
