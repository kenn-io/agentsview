...
<header class="header">
  <div class="header-left">
    <button
      ...
      title={$_("header.toggleSidebarTitle")}
      aria-label={$_("header.toggleSidebar")}
    >
    ...
    <button
      ...
      onclick={() => router.navigate("sessions")}
      title={$_("header.nav.sessions")}
      aria-label={$_("header.nav.sessions")}
    >
      <LayoutGridIcon size="12" strokeWidth="2" aria-hidden="true" />
      <span class="nav-label">{$_("header.nav.sessions")}</span>
    </button>
    ...
    <button
      ...
      title={$_("header.nav.usageTitle")}
      aria-label={$_("header.nav.usage")}
    >
      <Grid2x2Icon size="12" strokeWidth="2" aria-hidden="true" />
      <span class="nav-label">{$_("header.nav.usage")}</span>
    </button>
    ...
    <button
      ...
      title={$_("header.nav.activity")}
      aria-label={$_("header.nav.activity")}
    >
      <ActivityIcon size="12" strokeWidth="2" aria-hidden="true" />
      <span class="nav-label">{$_("header.nav.activity")}</span>
    </button>
    ...
    <div class="more-wrap">
      <button
        ...
        title={$_("header.nav.more")}
        aria-label={$_("header.nav.more")}
        aria-expanded={moreOpen}
      >
        <EllipsisIcon size="12" strokeWidth="2.4" aria-hidden="true" />
        <span class="nav-label">{$_("header.nav.moreLabel")}</span>
      </button>
      {#if moreOpen}
  ...
  <button
    ...
    title={$_("header.search.title", { values: { key: modKey } })}
  >
    <SearchIcon size="12" strokeWidth="2" aria-hidden="true" />
    <span class="search-hint-text">{$_("header.search.placeholder")}</span>
  ...
  <div class="header-right">
    {#if hasActiveSession}
      ...
      <div class="transcript-strip">
        <button
          ...
          aria-label={$_("header.transcript.normalAria")}
        >
        ...
        <button
          ...
          aria-label={$_("header.transcript.focusedAria")}
        >
        ...
        <div class="filter-wrap">
          <button
            ...
            title={$_("header.blockFilter.filterTitle")}
            aria-label={$_("header.blockFilter.filterTitle")}
          >
          ...
          {#if showBlockFilter}
            <div class="block-filter-dropdown" bind:this={filterDropRef}>
              <div class="block-filter-title">{$_("header.blockFilter.title")}</div>
      ...
      <button
        ...
        title={$_("header.followLatest")}
        aria-label={$_("header.followLatest")}
      ...
      <button
        ...
        title={$_("header.toggleSortTitle")}
        aria-label={$_("header.toggleSort")}
      >
      ...
      <button
        ...
        title={$_("header.cycleLayoutTitle", { values: { layout: ui.messageLayout } })}
        aria-label={$_("header.cycleLayout")}
      >
      ...
      <div class="export-wrap collapsible">
        <button
          ...
          title={$_("header.export.title")}
          aria-label={$_("header.export.aria")}
        ...
        {#if showExportMenu}
          <div class="export-dropdown" bind:this={exportDropRef}>
            ...
            >
              ...
              <span>{$_("header.export.downloadHtml")}</span>
            </button>
            <button
              class="overflow-item"
            ...
            >
              ...
              <span>
                {#if copiedMarkdownLink}
                  {$_("header.export.copiedMarkdownLink")}
                {:else}
                  {$_("header.export.copyMarkdownLink")}
                {/if}
              </span>
            </button>
            {#if activeSessionFilePath}
              ...
              >
                ...
                <span>{$_("header.export.copySourcePath")}</span>
              </button>
            {/if}
          </div>
        {/if}
      ...
      <div class="export-wrap collapsible">
        <button
          ...
          disabled={!sessions.activeSessionId}
          title={$_("header.publish.title")}
          aria-label={$_("header.publish.aria")}
        ...
        {#if showPublishMenu}
          <div class="export-dropdown" bind:this={publishDropRef}>
            ...
            >
              ...
              <span>{$_("header.publish.public")}</span>
            </button>
            <button
              class="overflow-item"
            ...
            >
              ...
              <span>{$_("header.publish.secret")}</span>
            </button>
          </div>
        {/if}
      </div>
      ...
      <div class="overflow-wrap">
        <button
          ...
          title={$_("header.overflow.moreActions")}
          aria-label={$_("header.overflow.moreActions")}
        >
        ...
        {#if showOverflow}
          <div class="overflow-dropdown" bind:this={overflowDropRef}>
            ...
            >
              ...
              <span>{$_("header.overflow.layout", { values: { layout: ui.messageLayout } })}</span>
            </button>
            <button
              class="overflow-item"
    ...
    <button
      ...
      title={sync.readOnly ? $_("header.sync.refreshTitle") : $_("header.sync.syncTitle")}
      aria-label={sync.readOnly ? $_("header.sync.refreshAria") : $_("header.sync.syncAria")}
    >
      <DatabaseBackupIcon size="14" strokeWidth="2" aria-hidden="true" />
      <span class="sync-label">{sync.readOnly ? $_("header.sync.refresh") : $_("header.sync.sync")}</span>
    </button>
    ...
    <button
      ...
      title={sync.readOnly
        ? $_("header.import.unavailable")
        : $_("header.import.title")}
      aria-label={$_("header.import.title")}
    >
      <DownloadIcon size="12" strokeWidth="2" aria-hidden="true" />
      <span class="import-label">{$_("header.import.label")}</span>
    </button>
    ...
    <button
      ...
      title={$_("header.shortcutsTitle")}
      aria-label={$_("header.shortcuts")}
    >
      ?
    </button>
  </div>
