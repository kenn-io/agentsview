...
// sessions.session_kind and messages.prompt_source columns. v10 moves common
// table creation to the canonical Bun registry. v11 adds an opaque mirror
// generation token for coherent multi-query Quack reads.
