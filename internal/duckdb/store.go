...
const duckSessionCols = `id, project, machine, agent,
	...
	data_version,
	COALESCE(codex_payload_certified_revision, '') AS codex_payload_certified_revision,
	COALESCE(codex_payload_certification_version, 0) AS codex_payload_certification_version,
