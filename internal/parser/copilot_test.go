...
// The official writer drops an assistant.usage insert that fails under a
// SQLite write lock, then accepts later events without replaying the lost one.
// A later timestamp therefore cannot prove earlier output is covered.
