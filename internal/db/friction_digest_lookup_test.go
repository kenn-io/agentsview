...
func seedDigest(t *testing.T, d *db.DB, date string, subjects []db.FrictionDigestSubject, patterns []db.FrictionPatternUpdate) {
	t.Helper()
...
func TestFrictionDigestLookups(t *testing.T) {
	d := dbtest.OpenTestDB(t)
	seedDigest(t, d, "2026-09-13",
