...
// Groups without a user message (assistant rows before the first user
// message land in exchange_no = 0) are excluded: the exchange contract is
// user-anchored.
func (db *DB) searchContentTerms(
	...
	predicates := []string{"exchange_no > 0"}
