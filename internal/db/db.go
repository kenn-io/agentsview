...
// initialized with the current schema and data version. It is intended for
// internal test helpers that copy a known-good template and want to avoid
// rerunning the full production migration path for every test case.
