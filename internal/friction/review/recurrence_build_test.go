...
func (*memStore) FrictionPatternsByFingerprint(context.Context, []string) (map[string]db.FrictionPattern, error) {
	panic("recurrence review without a ledger must not query pattern transitions")
}
