...
func TestCollectAndBatchReportsOrderedBulkFinalization(t *testing.T) {
	...
	// The end-of-pass scavenge is armed only once a source at or above the
	// scavenge threshold was retained; a bulk pass over small sources leaves
	// nothing worth returning to the OS.
