...
// QuarantineIterator owns one stable traversal of hidden artifacts until EOF
// or Close.
type QuarantineIterator interface {
	Next(context.Context, int) ([]QuarantinedEntry, error)
	Close() error
}
