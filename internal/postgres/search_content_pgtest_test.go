...
func TestPGSearchContentTermsRequiresUserBoundary(t *testing.T) {
	store := setupContentSearch(t)
	insertCSSession(t, store, "cs-terms-head", "proj", "claude",
		"2026-05-01T10:00:00Z", "2026-05-01T10:30:00Z")
	insertCSMessage(t, store, "cs-terms-head", 0, "assistant",
		"alpha beta without any user boundary", "2026-05-01T10:00:00Z", false)
	insertCSMessage(t, store, "cs-terms-head", 1, "user",
		"alpha", "2026-05-01T10:01:00Z", false)
	insertCSMessage(t, store, "cs-terms-head", 2, "assistant",
		"beta is set", "2026-05-01T10:02:00Z", false)
	...
	headOnly, err := store.SearchContent(t.Context(), db.ContentSearchFilter{
